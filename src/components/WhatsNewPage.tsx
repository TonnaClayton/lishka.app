              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 text-sm">
                      Get a sneak peek at the exciting features we're working on
                      to make your fishing adventures even better.
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <Card className="bg-white border-2 border-dashed border-gray-300">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Have a feature idea? Feel free to reach out to us on Instagram!
              </p>
              <Button
                variant="default"
                size="sm"
