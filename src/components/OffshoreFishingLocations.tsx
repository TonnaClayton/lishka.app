...
import OffshoreFishingCard from "./OffshoreFishingCard";
...
const OffshoreFishingLocations: React.FC<OffshoreFishingLocationsProps> = ({
      ...
      try {
        ...
        if (!forceRefresh) {
          ...
          if (
            ...
            console.log("📦 Using cached fishing locations data");
        ...
        console.log("🔄 Generating new fishing locations...");
  ...
  const handleRadiusChange = useCallback((radius: number) => {
    console.log(`🎯 Radius changed to ${radius}NM`);
  ...
  const handleLocationClick = useCallback(
    (location: OffshoreFishingLocation) => {
      console.log("🎣 Selected offshore fishing location:", location);
