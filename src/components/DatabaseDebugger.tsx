...
const DatabaseDebugger: React.FC = () => {
  ...
  const runDatabaseTests = async () => {
    ...
    try {
      console.log(
        "[DatabaseDebugger] Starting database tests for user:",
        user.id,
      );

      // Test 1: Check if profile exists and get raw data
      console.log("[DatabaseDebugger] Test 1: Fetching profile data...");
      ...
      console.log("[DatabaseDebugger] Profile fetch result:", {
        data: profileData,
        error: profileError,
      });
      ...
      console.log(
        "[DatabaseDebugger] Test 2: Testing gallery_photos update...",
      );
      const testPhotos = [
      ...
      console.log("[DatabaseDebugger] Update test result:", {
        data: updateData,
        error: updateError,
      });

      // Test 3: Fetch the updated data to verify
      console.log("[DatabaseDebugger] Test 3: Verifying update...");
      ...
      console.log("[DatabaseDebugger] Verification result:", {
        data: verifyData,
        error: verifyError,
      });
  ...
  const clearTestData = async () => {
    ...
    try {
      console.log("[DatabaseDebugger] Clearing test data...");
      ...
      if (error) {
        ...
        console.log("[DatabaseDebugger] Test data cleared successfully");
