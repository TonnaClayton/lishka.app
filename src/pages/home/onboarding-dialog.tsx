            ...
            <div className="absolute bottom-0 flex w-full flex-col items-center justify-center">
              ...
              >
                <button
                  disabled={isLoading}
                  className={
                    "flex-1 py-4 px-6 rounded-full text-white font-medium text-lg transition-colors hover:bg-blue-700 border-gray-200  border-0 bg-lishka-blue disabled:opacity-50 disabled:cursor-not-allowed"
                  }
                  onClick={() => {
                    if (current === 5) {
                      handleContinue();
