...
export function AddToHomeScreen(
  ...
  function _genIOSSafariIOS26(container: HTMLElement) {
    var containerInnerHTML =
      ...
      _genModalEnd() +
      (showArrow
        ? divBouncingArrow("ios-safari-bouncing-arrow-container") +
          `<img src="` +
          _genAssetUrl("ios-safari-bouncing-arrow.svg") +
          `" alt="arrow" />
    </div>`
  ...
  function _genIOSIPadSafariIOS26(container: HTMLElement) {
    var containerInnerHTML =
      ...
      _genModalEnd() +
      (showArrow
        ? divBouncingArrow("ios-ipad-safari-bouncing-arrow-container") +
          `<img src="` +
          _genAssetUrl("ios-safari-bouncing-arrow.svg") +
          `" alt="arrow" />
    </div>`
  ...
  function _genIOSChrome(container: HTMLElement) {
    var containerInnerHTML =
      ...
      _genModalEnd() +
      (showArrow
        ? divBouncingArrow("ios-chrome-bouncing-arrow-container") +
          `<img src="` +
  ...
  function _genIOSInAppBrowserUpperRightButtonOpenInSystemBrowser(
  ...
  function _genIOSInAppBrowserLowerRightButtonOpenInSafariBrowser(
    container: HTMLElement,
  ) {
    var containerInnerHTML =
      _genModalStart() +
  ...
  function _genAndroidChrome(container: HTMLElement) {
    var containerInnerHTML =
      ...
      _genModalEnd() +
      (showArrow
        ? divBouncingArrow("android-chrome-bouncing-arrow-container") +
          `<img src="` +
  ...
  function _genAndroidEdge(container: HTMLElement) {
    var containerInnerHTML =
      ...
      _genListItem(
        ...
        i18n.__(
          "Tap %s in the browser bar.",
          _genListButtonWithImage(_genAssetUrl("android-edge-more-button.svg")),
        ),
      ) +
      _genListItem(
        `2`,
      ...
      _genModalEnd() +
      (showArrow
        ? divBouncingArrow("android-edge-bouncing-arrow-container") +
          `<picture>
        <!-- Landscape image -->
        <source srcset="${_genAssetUrl(
  ...
  function _genBlurbMobile() {
    return _genBlurbWithMessage(
      i18n.__(
        ...
        "Install the Lishka app on your device to easily access it anytime. Simply, without an App Store.",
      ),
    );
  }
  ...
  function _genDesktopSafari(container: HTMLElement) {
    ...
    var containerInnerHTML =
      ...
      _genModalEnd() +
      (showArrow
        ? divBouncingArrow("desktop-safari-bouncing-arrow-container") +
          `<img src="` +
